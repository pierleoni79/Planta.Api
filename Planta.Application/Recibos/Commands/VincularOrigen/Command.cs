// Ruta: /Planta.Application/Recibos/Commands/VincularOrigen/Command.cs | V1.1
#nullable enable
using Planta.Application.Common.Exceptions;
using Planta.Contracts.Recibos;
using Planta.Contracts.Recibos.Requests;

namespace Planta.Application.Recibos.Commands.VincularOrigen;

public sealed record Command(VincularOrigenRequest Value) : IRequest<ReciboDto>;
...
public sealed class Handler : IRequestHandler<Command, ReciboDto>
{
    ...
    public async Task<ReciboDto> Handle(Command request, CancellationToken ct)
    {
        ...
        entity.VincularOrigen(v.PlantaId, v.AlmacenOrigenId, v.ClienteId);
